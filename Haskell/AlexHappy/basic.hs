...
alex_table = listArray (0 :: Int, 162)
  [ 0
  , 1
  , 2
  , 1
...
alex_check = listArray (0 :: Int, 162)
  [ -1
  , 97
  , 98
  , 97
...
alex_action_0 = \s -> A (length s)
alex_action_1 = \s -> B (length s)
